...
<div class="container">
    ...
    <div class="card">
        <h4 class="card-title text-center">Solve Exame</h4>
        <form method="POST" class="my-login-validation" action="{{ url( route('studentexam.store') ) }}">
            @csrf
           <input type="hidden" value="{{ $exam->practice_id }}" name="exam_id">
