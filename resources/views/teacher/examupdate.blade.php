...
<div class="container">
    ...
    <div class="card">
        ...
        <form method="POST" class="my-login-validation" action="{{ url( route('exam.update', [$id]) ) }}">
            @csrf
            <input type="hidden" value="{{ $exam->practice->resource->id }}" name="resource_id">
            <div class="form-group">
                <label for="title">Title</label>
                <input id="title" type="text" class="form-control " name="title"
                    value="{{$exam->practice->resource->title}}" autofocus>
            </div>
            <div class="form-group">
                <label for="description">Description</label>
                <input id="description" type="text" class="form-control "
                    value="{{ $exam->practice->resource->description }}" name="description" required>
            </div>
            <div class="form-group">
